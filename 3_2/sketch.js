...
function init(){
  ...
  for (var  i = 0; i < tot; i++){
    ...
    var col = color(100 * s); //Randomly choose between black and (182, 103, 13), with alpha equal to 2;

    elements.push( new Element(random(width),height/2, random(6, 160), col));
...
function Element(x, y, rad, col){
  ...
  */
  ...
  this.visualize = function(other, d){
    ...
    ellipse(this.pos.x, this.pos.y, 0.5, 0.5);
