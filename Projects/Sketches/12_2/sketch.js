...
let symmetrieNumber = 5; //how many arms the snowflake has (typically 6)
let angleVarianzPIDivider = 1; //PI is divided by this number to define the variance in branching angles
let radius = 150; //randius of the snowflake
...
let thicknesFactor = 1; //if the stroke thicknes is dependent on the lenght of the branch, this is multiplied with the length which is multiplied with the thickness
